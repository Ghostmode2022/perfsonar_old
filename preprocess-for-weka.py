...
print var1
print var2
fileNameI = sys.argv[1]+'-'+sys.argv[2]+'-packet-loss-rate'+'.txt'
fileNameO = sys.argv[1]+'-'+sys.argv[2]+'-packet-loss-rate'+'-output.txt'
...
textI = textI[1:-1]
#print textI
fileO.write('@predict throughput\n')
...
fileO.close()
fileI.close()
os.rename(sys.argv[1]+'-'+sys.argv[2]+'-packet-loss-rate'+'-output.txt', sys.argv[1]+'-'+sys.argv[2]+'-packet-loss-rate'+'-output.arff')
